...
const ProfessionalQualifications = () => {
  ...
  <Modal.Body>
    <Form onSubmit={handleSubmit}>
      {/* Row for Country and Institution */}
      <Row className="mb-3">
        <Col md={6}>
          ...
          <Form.Group controlId="institution">
            ...
            <CreatableSelect
              ...
              onCreateOption={(inputValue) => {
                ...
                availableInstitutions.push(newOption);
              }}
              value={
                formData.institution_id
                  ? {
                      label:
                        availableInstitutions.find((inst) => inst.id === formData.institution_id)?.name ||
                        formData.institution_id,
          ...
          <Form.Group controlId="course">
            ...
            <CreatableSelect
              ...
              onCreateOption={(inputValue) => {
                ...
                availableCourses.push(newOption);
              }}
              value={
                formData.course_id
                  ? {
                      label:
                        availableCourses.find((course) => course.id === formData.course_id)?.name ||
                        formData.course_id,
      ...
      <Row className="mb-3">
        <Col md={6}>
          <Form.Group controlId="started">
            <Form.Label className="fw-semibold">Started</Form.Label>
            <Form.Control
              type="date"
              name="started"
        ...
        <Col md={6}>
          <Form.Group controlId="ended">
            <Form.Label className="fw-semibold">Ended</Form.Label>
            <Form.Control
              type="date"
              name="ended"
